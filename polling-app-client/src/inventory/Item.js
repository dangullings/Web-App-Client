...
import { Modal, Avatar, Icon, Form, Button, notification, Input, Card, Switch } from 'antd';
...
class Item extends Component {
    ...
    render() {
        const {name, produceCost, saleCost, description, active} = this.state.item;
            ...
            <Form onSubmit={this.handleSubmit} className="student-form" {...layout}>
                ...
                <FormItem 
                    ...
                    <Input 
                        ...
                        value={produceCost} 
                        onChange={(event) => this.handleProduceCostChange(event, this.validateProduceCost)} />    
                </FormItem>
                ...
                <FormItem 
                    ...
                    <Input 
                        ...
                        value={saleCost} 
                        onChange={(event) => this.handleSaleCostChange(event, this.validateSaleCost)} />    
                </FormItem>
                ...
                <FormItem>
                    <Button {...buttonItemLayout} icon={<SaveOutlined />} type="primary" 
                        htmlType="submit"
                        //block={true}
                        shape="round" 
                        size="large"
                        onClick={this.updateItem}
                        disabled={this.isFormInvalid()}>Update Item</Button>
                </FormItem>
                <FormItem>
                    <Button {...buttonItemLayout} icon={<DeleteOutlined />} type="primary" danger 
                        size="large"
                        //block={true}
                        shape="round"
